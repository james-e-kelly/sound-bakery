...
RTTR_REGISTRATION
{
    ...
    registration::enumeration<SB_ACTION_TYPE>("SB_ACTION_TYPE")(
        value("Play", SB_ACTION_PLAY), value("Stop", SB_ACTION_STOP));

    registration::class_<Action>("SB::Engine::Action")
        .constructor<>()(policy::ctor::as_object)
        .property("Type", &Action::m_type)
        .property("Destination", &Action::m_destination)(metadata(
            SB::Editor::METADATA_KEY::Payload, SB::Editor::PayloadObject));

    registration::class_<EffectDescription>("SB::Engine::EffectDescription")
        .constructor<>()(policy::ctor::as_raw_ptr)
        .property("Type", &EffectDescription::getDSPType,
                  &EffectDescription::setDSPType)
        .property("Parameters", &EffectDescription::m_parameterDescriptions);

    registration::class_<EffectParameterDescription>(
        "SB::Engine::EffectParameterDescription")
        .constructor<>()(policy::ctor::as_object)
    ...
    registration::class_<DatabaseObject>("SB::Core::DatabaseObject")
        ...
        .property("ObjectID", &DatabaseObject::getDatabaseID,
                  &DatabaseObject::setDatabaseID)(
            metadata(SB::Editor::METADATA_KEY::Readonly, true))
        .property("ObjectName", &DatabaseObject::getDatabaseName,
                  &DatabaseObject::setDatabaseName);

    registration::class_<Sound>("SB::Engine::Sound")
        .constructor<>()(policy::ctor::as_raw_ptr)
        .property("Sound", &Sound::getSoundName, &Sound::setSoundName)(metadata(
            SB::Editor::METADATA_KEY::Payload, SB::Editor::PayloadSound));
    ...
    registration::class_<Node>("SB::Engine::Node")
        ...
        .property("Volume", &Node::m_volume)(
            metadata(SB::Editor::METADATA_KEY::MinMax,
                     std::pair<float, float>(0.0f, 1.0f)))
        .property("Pitch",
                  &Node::m_pitch)(metadata(SB::Editor::METADATA_KEY::MinMax,
                                           std::pair<float, float>(0.0f, 2.0f)))
    ...
    registration::class_<SoundContainer>("SB::Engine::SoundContainer")
        .constructor<>()(policy::ctor::as_raw_ptr)
        .property("Sound", &SoundContainer::m_sound)(metadata(
            SB::Editor::METADATA_KEY::Payload, SB::Editor::PayloadSound));
