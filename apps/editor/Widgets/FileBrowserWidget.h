...
public:
    ...
    const std::string& GetSelectedFileName() const { return m_selectedFileString; }

private:
    void UnselectItem() noexcept;
    ButtonState DrawWideButton(bool selected, uint32_t hoveredColor, uint32_t activeColor) const noexcept;
