...
void SplashWidget::Start()
{
    ...
    unsigned char* image_data = stbi_load(GetApp()->GetResourceFilePath("images/SplashImage.png").c_str(), &image_width, &image_height, &n, 0);
...
void SplashWidget::CloseSplashScreen()
{
    m_wantsToShow = false;
}
...
void SplashWidget::Render()
{
    ...
    if (ImGui::BeginPopupModal(SplashScreenUtils::splashScreenName, NULL, ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoTitleBar))
    {
