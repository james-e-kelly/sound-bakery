...
{
    co_return co_await get_api<bool>(m_client, review_app_endpoints::me, httplib::Params{{review_app_parameters::activityType, std::to_string((int)activityType)}});
}
...
{
    co_return co_await get_api<std::vector<comment_data>>(m_client, review_app_endpoints::comments, httplib::Params{{review_app_parameters::reviewId, std::to_string(reviewId)}});
}
...
{
    std::vector<user_data> users = co_await get_api<std::vector<user_data>>(m_client, review_app_endpoints::users, httplib::Params{{review_app_parameters::userId, std::to_string(userId)}, {review_app_parameters::reviewId, std::to_string(reviewId)}, {review_app_parameters::projectId, std::to_string(projectId)}});
...
{
    co_return co_await get_api<std::vector<activity_data>>(m_client, review_app_endpoints::activity, httplib::Params{{review_app_parameters::reviewId, std::to_string(reviewId)}});
}
...
auto review_client::post_project(const std::string projectName, const std::string projectDescription) -> concurrencpp::result<database_id>
{
    ...
    const auto postResult = m_client->Post(review_app_endpoints::projects, httplib::Headers(), httplib::Params{{review_app_parameters::name, projectName}, {review_app_parameters::description, projectDescription}});
...
{
    co_return co_await put_api(m_client, review_app_endpoints::reviews, httplib::Params{{review_app_parameters::reviewId, std::to_string(reviewId)}, {review_app_parameters::reviewStatus, std::to_string((int)status)}});
}

auto review_client::put_review_vote(database_id reviewId, database_id userId, review_vote vote) -> concurrencpp::result<void>
{
    co_return co_await put_api(m_client, review_app_endpoints::reviewVotes, httplib::Params{{review_app_parameters::reviewId, std::to_string(reviewId)}, {review_app_parameters::userId, std::to_string(userId)}, {review_app_parameters::reviewVote, std::to_string((int)vote)}});
}
