    ...
    public:
        ...
        virtual void gatherSounds(std::vector<Container*>& soundContainers, const RuntimeFloatParameterMap& runtimeFloatParameters, const RuntimeIntParameterMap& runtimeIntParameters) override
        {
            ...
            case 0:
                break;
            case 1:
                dynamic_cast<Container*>(m_childNodes.begin()->raw())->gatherSounds(soundContainers, runtimeFloatParameters, runtimeIntParameters);
                break;
            default:
                ...
                dynamic_cast<Container*>(childIter->raw())->gatherSounds(soundContainers, runtimeFloatParameters, runtimeIntParameters);
                break;
            }
        }
