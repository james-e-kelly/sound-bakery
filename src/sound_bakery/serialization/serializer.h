...
namespace SB::Core::Serialization
{
    ...
    {
    public:
        static void saveObject(SB::Core::Object* object,
                               YAML::Emitter& emitter);

    public:
        static void saveSystem(SB::Engine::System* system,
                               YAML::Emitter& emitter);
    ...
    private:
        static bool saveInstance(YAML::Emitter& emitter,
                                 rttr::instance instance);

        static bool saveVariant(YAML::Emitter& emitter,
                                rttr::string_view name,
                                rttr::variant& variant);

        static bool saveStringVariant(YAML::Emitter& emitter,
                                      rttr::string_view name,
                                      rttr::variant variant);

        static bool saveEnumVariant(YAML::Emitter& emitter,
                                    rttr::string_view name,
                                    rttr::variant variant);
        ...
        static bool saveClassVariant(YAML::Emitter& emitter,
                                     rttr::string_view name,
                                     rttr::variant variant);
    };
}  // namespace SB::Core::Serialization
