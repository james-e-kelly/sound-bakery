...
extern "C"
{
     ...
     */
    sbk_result SC_API sc_system_create(sc_system** outSystem);

    /**
     * @brief Releases the system memory.
     * @see sc_system_close sc_system_create
     */
    sbk_result SC_API sc_system_release(sc_system* system);
     ...
     */
    sbk_result SC_API sc_system_log_init(sc_system* system, ma_log_callback_proc logCallback);
     ...
     * sounds.
     */
    sbk_result SC_API sc_system_init(sc_system* system, const sc_system_config* systemConfig);
     ...
     */
    sbk_result SC_API sc_system_close(sc_system* system);

    ////////////////////////////////////////////////////////////////////////////

    sbk_result SC_API sc_system_create_sound(sc_system* system,
                                            const char* fileName,
                                            sc_sound_mode mode,
                                            sc_sound** sound);

    sbk_result SC_API sc_system_create_sound_memory(
     ...
     * @return
     */
    sbk_result SC_API sc_system_play_sound(
     ...
     */
    sbk_result SC_API sc_system_create_node_group(sc_system* system, sc_node_group** nodeGroup);
    ...
    sbk_result SC_API sc_dsp_get_parameter_float(sc_dsp* dsp, int index, float* value);
    sbk_result SC_API sc_dsp_set_parameter_float(sc_dsp* dsp, int index, float value);
    sbk_result SC_API sc_dsp_get_metering_info(sc_dsp* dsp,
                                              ma_uint32 channelIndex,
                                              sc_dsp_meter meterType,
                                              float* value);
    sbk_result SC_API sc_dsp_release(sc_dsp* dsp);

    sbk_result SC_API sc_node_group_set_volume(sc_node_group* nodeGroup, float volume);
    sbk_result SC_API sc_node_group_get_volume(sc_node_group* nodeGroup, float* volume);

    sbk_result SC_API sc_node_group_set_parent(sc_node_group* nodeGroup, sc_node_group* parent);
    sbk_result SC_API sc_node_group_set_parent_endpoint(sc_node_group* nodeGroup);

    sbk_result SC_API sc_node_group_get_dsp(sc_node_group* nodeGroup, sc_dsp_type type, sc_dsp** dsp);

    sbk_result SC_API sc_node_group_add_dsp(sc_node_group* nodeGroup, sc_dsp* dsp, sc_dsp_index index);
    sbk_result SC_API sc_node_group_remove_dsp(sc_node_group* nodeGroup, sc_dsp* dsp);

    sbk_result SC_API sc_node_group_release(sc_node_group* nodeGroup);

    // CLAP

    sbk_result SC_API sc_system_clap_get_count(sc_system* system, ma_uint32* count);
     ...
     */
    sbk_result SC_API sc_system_clap_get_at(sc_system* system, ma_uint32 index, sc_clap** plugin);
